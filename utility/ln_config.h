...
#define LN_SW_UART_RX_INVERTED		//if used with an interface with Serialport like behavior, Rx and Tx need to use the same logic level
#define LN_SW_UART_TX_INVERTED  	// Normal is to be inverted...
